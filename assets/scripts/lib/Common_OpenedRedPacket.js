var o = require("./Common_ShareUtils"),
    i = require("./Common_RedPacketPage"),
    ...
    l = function(s) {
        ...
        return __extends(t, s), t.prototype.start = function() {
            ...
            }, t.prototype.refresh = function(a, e, t, o, i) {
                this.money.string = a + "元", this.playCallback = e, this.ruleText = t, this.activityRuleText = o,
                    i ? (this.btnDec.string = "继续开红包", this.tip.node.active = !1) : (this.btnDec.string = "玩游戏拿红包",
                        this.tip.node.active = !0), this.isGetRed = i;
            }, t.prototype.onLook = function() {
                this.onClose();
            }, t.prototype.onClose = function() {
                console.log("回到红包页面"), i.default.instance ? i.default.instance.refresh(!0) : o.default.showRedPacketPage(this.ruleText, this.playCallback, this.activityRuleText),
